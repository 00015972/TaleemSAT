...
**Implementation update:** [Step 01 — framework security update](audits/2026-09-11/step-01-framework-update.md), [Step 02 — mock-test restriction](audits/2026-09-11/step-02-mock-test-restriction.md), [Step 03 — answer-key protection](audits/2026-09-11/step-03-answer-key-protection.md), [Step 04 — authentication redirect validation](audits/2026-09-11/step-04-authentication-redirects.md), [Step 06 — grid-in grading and API validation](audits/2026-09-11/step-06-grid-in-api-validation.md), and [Step 07 — practice navigation and submission races](audits/2026-09-11/step-07-practice-navigation-submission-races.md) are complete locally. [Step 05 — signup confirmation and password recovery](audits/2026-09-11/step-05-auth-confirmation-recovery.md) is implemented locally, but its hosted URL, email-template, SMTP, rate-limit, and clean-browser delivery checks remain open pending access to the configured Supabase project. [Step 08 — authoritative, retry-safe attempts](audits/2026-09-11/step-08-authoritative-retry-safe-attempts.md) is implemented and verified locally; its production migration requires explicit approval before the application can be deployed. [Step 10 — public landing, support, and release truthfulness](audits/2026-09-11/step-10-public-landing-support.md) is implemented and verified locally; operator/legal review, hosted authentication checks, production settings, backup restoration, and rollback verification remain open. Next.js and its ESLint configuration are now 16.3.4; critical advisory records dropped to zero; mock tests are server-restricted; student access to grading keys is denied; authentication destinations are validated; signup/recovery no longer depend on incomplete client-only transitions; grid-in/API inputs have bounded runtime validation; practice navigation is race-safe; practice/mock attempt recording now has a server-owned session contract locally; and the public entrance is static, truthful about the free beta, and connected to working help/legal routes. The findings and measurements below describe the original `9bb0af5` audit baseline.
...
**Implementation status:** implemented and verified locally in [Step 08](audits/2026-09-11/step-08-authoritative-retry-safe-attempts.md). Migration 015 is pending explicit approval on the connected production project, so this item is not yet deployable.
